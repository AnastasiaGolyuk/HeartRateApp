...
fun ReportScreen() {
    ...
    Box(modifier = Modifier.fillMaxSize().background(GreyBg)) {
        Column(
            modifier = Modifier
                .fillMaxSize(),
            ...
            Box(contentAlignment = Alignment.TopCenter) {
                Image(
                    ...
                    painter = painterResource(id = R.drawable.report_img2),
                    contentDescription = "",
                )
                Text(
                    modifier = Modifier.align(Alignment.BottomCenter),
                    text = "Here you can see your reports.\n" +
